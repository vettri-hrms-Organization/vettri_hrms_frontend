...
// then component primitives, then the premium visual layer that refines
// shared surfaces (cards, tables, nav, dashboard) last so it wins ties
// without needing !important. This used to be three separate patch files
// (visual-polish / dashboard-layout-polish / final-product-qa) that
// redefined the same classes with conflicting values — consolidated into
// one file, see premium.css for details.
import './design-system/styles/custom.scss';
import './design-system/styles/tokens.css';
import './design-system/styles/global.css';
import './components/ui/components.css';
import './design-system/styles/premium.css';
