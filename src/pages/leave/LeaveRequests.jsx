...
export default function LeaveRequests() {
  ...
  if (user?.employeeId && !hasPermission('LEAVE_VIEW') && !hasPermission('LEAVE_APPROVE') && !hasPermission('LEAVE_MANAGE')) return <EmployeeLeaveWorkspace employeeId={user.employeeId} />;
