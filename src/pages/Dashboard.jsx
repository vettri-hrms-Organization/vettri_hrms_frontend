  ...
  export default function Dashboard() {
    ...
    return (
      <div className="hz-dashboard hz-dashboard--admin">
        <header className="hz-dashboard__welcome">
          <div>
            <p className="hz-dashboard__eyebrow text-dark">{today}</p>
            <h1 className="hz-dashboard__eyebrow text-dark">{greeting}, {firstName || 'Vikkash'}</h1>
            <p className="hz-dashboard__eyebrow text-muted">Here&apos;s what&apos;s happening across your organization today.</p>
          </div>
          <div className="hz-dashboard__welcome-mark" aria-hidden="true"><Users size={21} /></div>
        </header>
